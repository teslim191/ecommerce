  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      <div class="navbar-nav ms-auto" style="padding-right: 40px;">
        <a id="nav" class="nav-link active px-3" aria-current="page" href="Admindashb.php"><i class='fas fa-user fa-1x'></i></a>
        <a id="nav" class="nav-link active px-3" href="Home.php">Home</a>
